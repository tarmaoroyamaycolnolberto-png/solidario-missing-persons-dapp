...
function WalletIcon() {
  return (
    <svg
      className="create-case-info-icon"
      viewBox="0 0 24 24"
      aria-hidden="true"
      fill="none"
    ...
    >
      <path
        d="M3 7.5C3 6.12 4.12 5 5.5 5H18"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
      />
...
function UploadIcon() {
  return (
    <svg
      className="create-case-upload-icon"
      viewBox="0 0 24 24"
      aria-hidden="true"
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
...
function ImageIcon() {
  return (
    <svg
      className="create-case-preview-icon"
      viewBox="0 0 24 24"
      aria-hidden="true"
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
    >
      ...
      <path
        d="M21 15L16.6 11.2C16.12 10.79 15.41 10.82 14.97 11.26L10.4 15.83"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
...
function CreateCaseForm({ account, setMessage }) {
  ...
  function handleImageChange(e) {
    ...
    if (invalidFile) {
      setMessage("Todos los archivos deben ser imágenes válidas");
      e.target.value = "";
      return;
    }
    ...
    if (combined.length > 3) {
      setMessage("Solo puedes subir un máximo de 3 imágenes");
      e.target.value = "";
      return;
    }
  ...
  async function handleCreateCase() {
    ...
    try {
      ...
      if (imageFiles.length === 0) {
        throw new Error("Debes subir entre 1 y 3 imágenes");
      }
      ...
      await createCaseOnChain(account, metadataCID, account);
    ...
    <section className="section-card compact-form-card create-case-panel">
      ...
      <div className="create-case-wallet-card compact-banner">
        ...
        <div className="create-case-wallet-content">
          <span className="auto-recipient-label create-case-wallet-label">
            Wallet receptora automática
          </span>
          <p className="auto-recipient-value create-case-wallet-value">
            {account || "Conecta tu wallet para usarla como wallet receptora"}
          </p>
        </div>
      </div>
      ...
      <div className="create-case-form-shell">
        <div className="create-case-block">
          <div className="create-case-block-head">
            ...
            <p className="create-case-block-text">
          ...
          <div className="form-grid compact-form-grid create-case-grid">
            ...
            <div className="form-group">
              <label className="form-label">Ciudad o distrito</label>
              <input
                className="form-input compact-input"
                type="text"
        ...
        <div className="create-case-block create-case-upload-block">
          <div className="create-case-block-head">
            ...
            <p className="create-case-block-text">
              Sube entre 1 y 3 imágenes. La primera será la principal del caso.
            </p>
          </div>
          ...
          <div className="image-upload-box compact-upload-box create-case-upload-box">
            <div className="create-case-upload-main">
              <div className="create-case-upload-badge">
                <UploadIcon />
              </div>
          ...
          {imageFiles.length > 0 && (
            <div className="create-case-preview-summary">
              <span className="create-case-preview-counter">
                {imageFiles.length} imagen{imageFiles.length > 1 ? "es" : ""} cargada
                  ...
                  <div className="upload-preview-content create-case-preview-content">
                    <div className="create-case-preview-meta">
                      <div className="create-case-preview-meta-top">
                        <ImageIcon />
                        <span className="create-case-preview-index">
                          Imagen {index + 1}
                        </span>
                      </div>

                      <p className="upload-preview-filename" title={preview.name}>
                        {preview.name}
                      </p>
                    </div>
